...
figure; hold on;
lev = [ 1 3 ];
load('Dw1T2RnfL2.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Rd(3,:));

load('Dw5T2RnfL2.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Rd(8,:));

load('Dw10T2RnfL2.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
...
figure; hold on;
lev = [ 1 3 ];
load('Dw1T2RnfL5.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Bl(4,:));

load('Dw5T2RnfL5.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Bl(7,:));

load('Dw10T2RnfL5.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Bl(9,:));
set(gca,'fontsize',30);
ylabel('$\beta$','fontsize',30,'interpreter','latex');
xlabel('$D_v$','fontsize',30,'interpreter','latex');
...
figure; hold on;
lev = [ 1 3 ];
load('Dw1T2RnfL10.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Gr(4,:));

load('Dw5T2RnfL10.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Gr(7,:));

load('Dw10T2RnfL10.mat','time','list_B','list_Dv','Dw','theta')
[B1,hfigc] = contour(log10(list_Dv),list_B,log10(time),lev);
set(hfigc,'LineWidth',7.0,'Color',Gr(9,:));
set(gca,'fontsize',30);
ylabel('$\beta$','fontsize',30,'interpreter','latex');
xlabel('$D_v$','fontsize',30,'interpreter','latex');
